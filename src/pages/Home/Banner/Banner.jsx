            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle text-[#f17941]">❮</a>
                        <a href="#slide2" className="btn btn-circle text-[#f17941]">❯</a>
                    </div>
                </div>
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/pj4b1fM/loic-lifeofpix-loic-310630.jpg" className="w-full md:h-[700px]" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide1" className="btn btn-circle text-[#f17941]">❮</a>
                        <a href="#slide3" className="btn btn-circle text-[#f17941]">❯</a>
                    </div>
                </div>
