...
const Navbar = () => {
  ...
  const navLink = <>
    <li><NavLink to={'/'} className={({ isActive }) => isActive ? 'text-[#e36f6b]  border border-[#f17941] font-bold  p-2 rounded-md text-xl' : 'text-[#f17941] text-xl'}>Home</NavLink></li>
    <li><NavLink to={'/allArt'} className={({ isActive }) => isActive ? 'text-[#e36f6b]  border border-[#f17941] font-bold  p-2 rounded-md text-xl' : 'text-[#f17941] text-xl'}>All Art & craft</NavLink></li>
    {loading ? <span className="loading loading-dots loading-md"></span> : user && <li><NavLink to={'/addArt'} className={({ isActive }) => isActive ? 'text-[#e36f6b] border border-[#f17941] font-bold  p-2 rounded-md text-xl' : 'text-[#f17941] text-xl'}>Add Art & craft</NavLink></li>}
    {loading ? <span className="loading loading-dots loading-md"></span> : user && <li><NavLink to={'/myArt'} className={({ isActive }) => isActive ? 'text-[#e36f6b]   border border-[#f17941] font-bold  p-2 rounded-md text-xl' : 'text-[#f17941] text-xl'}>my Art & craft</NavLink></li>}


  </>
  return (
    <nav className="navbar bg-base-content bg-opacity-5 absolute z-10 container">
      <div className="navbar-start">
        <div className="dropdown">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#f17941]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
          </div>
