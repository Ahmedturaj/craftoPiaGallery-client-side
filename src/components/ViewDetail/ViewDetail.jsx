        ...
        <div className="hero min-h-screen bg-base-200 my-14">
            ...
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p className='text-xl mb-3'><span className='text-[#f17941]'>Author's name:</span>{user_name}</p>
                    <p className='text-xl mb-3'><span className='text-[#f17941]'>Author's email:</span>{user_email}</p>
                ...
                <p className='flex items-center gap-2 text-xl mb-3'><span className='text-[#f17941] font-bold text-xl'><FaStar className='text-[#f17941]' /></span> <span className='text-[#f17941]'>Rating</span>:{rating}</p>
